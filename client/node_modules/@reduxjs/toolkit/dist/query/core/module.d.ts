    ...
    interface ApiModules<BaseQuery extends BaseQueryFn, Definitions extends EndpointDefinitions, ReducerPath extends string, TagTypes extends string> {
        [coreModuleName]: {
            ...
            util: {
                ...
                getRunningOperationPromise<EndpointName extends QueryKeys<Definitions>>(endpointName: EndpointName, args: QueryArgFrom<Definitions[EndpointName]>): QueryActionCreatorResult<Definitions[EndpointName]> | undefined;
                getRunningOperationPromise<EndpointName extends MutationKeys<Definitions>>(endpointName: EndpointName, fixedCacheKeyOrRequestId: string): MutationActionCreatorResult<Definitions[EndpointName]> | undefined;
                /**
